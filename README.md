...
# Akaltye
### Eastern & Central Arrernte Language App
...
- [Akaltye Wiki](https://github.com/SamMadeThis/Akaltye/wiki)
...
Arrernte is a language with deep cultural significance to Aboriginal peoples of Central Australia. Akaltye aims to support:

- 🏠 Arrernte people wanting to reconnect with or strengthen their language
- 📖 Anyone interested in learning Arrernte
- 🌱 Long-term preservation of the language through digital tools
...
| Feature | Status |
|---|---|
| Language learning tools | ✅ Live |
| User progress tracking | ✅ Live |
| Arrernte language database | 🔄 Growing |
